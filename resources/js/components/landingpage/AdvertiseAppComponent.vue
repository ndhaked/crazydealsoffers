        ...
        <div class="static-content">
            <div class="container">
                ...
                <div class="image-static-data">
                    <div class="col-sm-12">
                    <img :src="baseUrl+'/front/images/advertise-1.png'" alt="">
                    </div>
                    <div class="col-sm-12">
                ...
                <div class="image-static-data">
                    ...
                    <div class="row align-items-center">
                        ...
                        <img :src="baseUrl+'/front/images/advertise-2.jpg'" alt="">
                        </div>
                ...
                <div class="image-static-data">
                    ...
                    <div class="row align-items-center">
                        ...
                        <img :src="baseUrl+'/front/images/advertise-3.jpg'" alt="">
                        </div>
                    <div class="col-lg-6 col-md-12">
                        <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident,
                ...
                <div class="col-sm-12 text-center">
                    <a href="javascript:void(0);" class="btn btn-primary width-btn">
                    Contact Us
                    </a>
                </div>
                </div>
