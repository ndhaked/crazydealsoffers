...
return [
    ...
    */
    'success' => [
        'remove_inactive_products' => 'All inactive products are removed successful',
        'user_updated_successfully' => 'Profile update successful',
        'slider_created_successfully' => 'Banner created successful',
        'slider_updated_successfully' => 'Banner created successful',
        'slider_deleted_successfully' => 'Banner deleted successful',
        'slider_status_updated_successfully' => 'Slier status updated successfully',
        ...
        'product_csv_uploaded_successfully' => 'Product CSV uploaded successfully',
        'product_deal_status_updated_successfully' => 'Product deal status updated successfully',
        ...
        'blog_image_removed_successfully' => 'Blog image remove successfully',
        ...
        'advertisaffiliated_updated_successfully' => 'Advertise Affiliated updated successfully',
    ...
    'error' => [
        ...
        'notifications_not_in_records' => 'Notification not in records.',
        ...
        'record_not_available_now' => 'Record not available.',
        'you_have_not_permission_for_this_page_access' => 'User have not permission for this page access',
        'cant_upload_product_csv' => 'cannot upload product CSV',
        'cant_upload_product_csv' => 'cannot upload product CSV',
        'already_subscribe' => 'Email is Already Subscribed',
        'subscribe_failed' => 'This email is not supported',
        'slider_limitation' => 'Maximum 5 banner are allowed at a time.',
    ],
    'alerts' => [
    ...
    'info' =>[
        'price_can_expire_any_time'=>'Prices, coupons and codes are valid at time of posting and can expire at anytime. CN Deals and Coupons may earn a small commission via affiliate links. Read full',
        'affiliate_disclosure_here'=>'affiliate disclosure here'
    ]
