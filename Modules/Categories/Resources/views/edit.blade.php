...
@section('content')
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route($model.'.index')}}">@lang($model.'::menu.sidebar.menu_title')</a></li>
    ...
    <section class="content">
      ...
      <div class="box-footer">
           <div class="row pull-right">
              <div class="col-sm-12">
                 <button class="btn btn-primary formsubmit" type="submit">{{trans('menu.sidebar.update')}}</button>
